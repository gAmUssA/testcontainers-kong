...
public class Unhealthy__2 {
     ...
     * @param interval
     */
    public Unhealthy__2(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy__2 withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy__2 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy__2 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Unhealthy__2 withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
    ...
    public Unhealthy__2 withTimeouts(Integer timeouts) {
        this.timeouts = timeouts;
        return this;
    }
