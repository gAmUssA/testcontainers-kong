...
public class Healthy__1 {
     ...
     * @param interval
     */
    public Healthy__1(List<Integer> httpStatuses, Integer interval, Integer successes) {
        super();
    ...
    public Healthy__1 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Healthy__1 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Healthy__1 withSuccesses(Integer successes) {
        this.successes = successes;
        return this;
    }
