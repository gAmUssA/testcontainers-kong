...
public class Unhealthy__4 {
     ...
     * @param interval
     */
    public Unhealthy__4(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy__4 withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy__4 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy__4 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Unhealthy__4 withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
    ...
    public Unhealthy__4 withTimeouts(Integer timeouts) {
        this.timeouts = timeouts;
        return this;
    }
