...
public class Service {
     ...
     * @param updatedAt
     */
    public Service(List<String> caCertificates, Certificate clientCertificate, Integer connectTimeout, Integer createdAt, String host, String id, String name, String path, Integer port, String protocol, Integer readTimeout, Integer retries, List<String> tags, Boolean tlsVerify, Integer tlsVerifyDepth, Integer updatedAt, String url, Integer writeTimeout) {
        super();
    ...
    public Service withCaCertificates(List<String> caCertificates) {
        this.caCertificates = caCertificates;
        return this;
    }
    ...
    public Service withClientCertificate(Certificate clientCertificate) {
        this.clientCertificate = clientCertificate;
        return this;
    }
    ...
    public Service withConnectTimeout(Integer connectTimeout) {
        this.connectTimeout = connectTimeout;
        return this;
    }
    ...
    public Service withCreatedAt(Integer createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public Service withReadTimeout(Integer readTimeout) {
        this.readTimeout = readTimeout;
        return this;
    }
    ...
    public Service withTlsVerify(Boolean tlsVerify) {
        this.tlsVerify = tlsVerify;
        return this;
    }
    ...
    public Service withTlsVerifyDepth(Integer tlsVerifyDepth) {
        this.tlsVerifyDepth = tlsVerifyDepth;
        return this;
    }
    ...
    public Service withUpdatedAt(Integer updatedAt) {
        this.updatedAt = updatedAt;
        return this;
    }
    ...
    public Service withWriteTimeout(Integer writeTimeout) {
        this.writeTimeout = writeTimeout;
        return this;
    }
