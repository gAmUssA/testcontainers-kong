...
public class Unhealthy {
     ...
     * @param interval
     */
    public Unhealthy(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
