...
public class Unhealthy__6 {
     ...
     * @param interval
     */
    public Unhealthy__6(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy__6 withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy__6 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy__6 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Unhealthy__6 withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
    ...
    public Unhealthy__6 withTimeouts(Integer timeouts) {
        this.timeouts = timeouts;
        return this;
    }
