...
public class Certificate {
     ...
     * @param tags
     */
    public Certificate(String cert, Integer createdAt, String id, String key, List<String> snis, List<String> tags) {
        super();
        this.cert = cert;
    ...
    public Certificate withCreatedAt(Integer createdAt) {
        this.createdAt = createdAt;
        return this;
    }
