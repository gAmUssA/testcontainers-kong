...
public class FPlugin {
     ...
     * @param tags
     */
    public FPlugin(String config, String consumer, Integer createdAt, Boolean enabled, String id, String name, List<String> protocols, String route, String runOn, String service, List<String> tags) {
        super();
        this.config = config;
    ...
    public FPlugin withConfig(String config) {
        this.config = config;
        return this;
    }
    ...
    public FPlugin withCreatedAt(Integer createdAt) {
        this.createdAt = createdAt;
        return this;
    }
    ...
    public FPlugin withRunOn(String runOn) {
        this.runOn = runOn;
        return this;
    }
