...
public class Unhealthy__1 {
     ...
     * @param interval
     */
    public Unhealthy__1(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy__1 withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy__1 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy__1 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Unhealthy__1 withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
    ...
    public Unhealthy__1 withTimeouts(Integer timeouts) {
        this.timeouts = timeouts;
        return this;
    }
