...
public class Unhealthy__7 {
     ...
     * @param interval
     */
    public Unhealthy__7(Integer httpFailures, List<Integer> httpStatuses, Integer interval, Integer tcpFailures, Integer timeouts) {
        super();
    ...
    public Unhealthy__7 withHttpFailures(Integer httpFailures) {
        this.httpFailures = httpFailures;
        return this;
    }
    ...
    public Unhealthy__7 withHttpStatuses(List<Integer> httpStatuses) {
        this.httpStatuses = httpStatuses;
        return this;
    }
    ...
    public Unhealthy__7 withInterval(Integer interval) {
        this.interval = interval;
        return this;
    }
    ...
    public Unhealthy__7 withTcpFailures(Integer tcpFailures) {
        this.tcpFailures = tcpFailures;
        return this;
    }
    ...
    public Unhealthy__7 withTimeouts(Integer timeouts) {
        this.timeouts = timeouts;
        return this;
    }
